#
# Pre_Prod_InstallCRM.ps1
#
#
# STEP 0: Sandbox solution started on 2 applications servers 03 & 04
# STEP 1 Create content DB and site collection
New-SPContentDatabase "BB2013_PreProd_CRM_Content" -DatabaseServer "MRSSPSSPPP\SPPP" -WebApplication https://intranet-pre.bourbon-online.com -MaxSiteCount 5000 -WarningSiteCount 2000
#Add database to AG
New-SPManagedPath "crm" -WebApplication "https://intranet-pre.bourbon-online.com" -Explicit

$url = "https://intranet-pre.bourbon-online.com/crm"
$ContentDatabase = "BB2013_PreProd_CRM_Content"
$WebsiteName = "CRM"
...
C:\Distrib\crm\AllowHtcExtn.ps1 "https://intranet-pre.bourbon-online.com"
